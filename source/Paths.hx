...
class Paths
{
        // Mobile usa OGG por padrão para melhor performance e compatibilidade
        ...
        {
                // Habilita cache para Android também, não só Windows/Mac
        ...
        {
                // Garante que o Caching.hx exista no seu projeto para não dar erro
